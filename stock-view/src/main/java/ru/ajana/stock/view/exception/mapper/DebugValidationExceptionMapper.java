...
/**
 * {@link ExceptionMapper} for {@link ValidationException}. <p> Send a {@link ViolationReport} in
 * {@link Response} in addition to HTTP 400/500 status code. Supported media types are: {@code
 * application/json} / {@code application/xml} (if appropriate provider is registered on server).
 * </p>
 *
 * @see org.jboss.resteasy.api.validation.ResteasyViolationExceptionMapper The original WildFly
 * class: {@code org.jboss.resteasy.api.validation.ResteasyViolationExceptionMapper}
 */
@Provider
public class DebugValidationExceptionMapper implements ExceptionMapper<ValidationException> {
